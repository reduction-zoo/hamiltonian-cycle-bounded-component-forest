...
The prepared general-K label/depth oracle was committed before construction (865be96), self-tested on 9 source and 7 target fixtures, and is independently derived from graph connectivity. The final prepared candidate run is still in progress; its completed result will be recorded separately. The additional solver above has already covered the graph forms in that suite, including consistent target decoding and infeasibility, without obtaining a witness from the candidate.
